...
namespace Garage_3._0.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public VehicleTypesController(Garage_3_0Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeName,Size")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeName,Size")] VehicleType vehicleType)
        {
