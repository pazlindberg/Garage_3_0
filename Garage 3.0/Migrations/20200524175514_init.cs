        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NrOfVehicles = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeOfArrival = table.Column<DateTime>(nullable: true, defaultValueSql: "getdate()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Member",
                columns: new[] { "Id", "Email", "FirstName", "LastName", "NrOfVehicles" },
                values: new object[,]
                {
                    { 1, "johan.andersson@gmail.com", "Johan", "Andersson", 2 },
                    { 2, "anna.lind@yahoo.se", "Anna", "Lind", 1 },
                    { 3, "dimman@lexicon.se", "Dimitris", "Björlingh", 1 },
                    { 4, "bruce.lee@jeetkunedo.cn", "Bruce", "Lee", 1 },
                    { 5, "saka.kivi@soumi.fi", "Sakari", "Kivimäki", 0 }
                });
